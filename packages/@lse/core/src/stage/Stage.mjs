...
import { CStage, logger } from '../addon/index.mjs'
import { InputManager } from '../input/InputManager.mjs'
import { AudioManager } from '../audio/AudioManager.mjs'
import { logexcept, now, isPlainObject } from '../util/index.mjs'
import { PluginType } from '../addon/PluginType.mjs'
import { PluginId } from '../addon/PluginId.mjs'
import {
  createAttachedEvent,
...
import { loadPlugin } from '../addon/loadPlugin.mjs'
import { EventTarget } from '../event/EventTarget.mjs'
import { FontManager } from '../font/FontManager.mjs'
