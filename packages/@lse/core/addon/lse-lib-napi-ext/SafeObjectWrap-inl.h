...
template<typename T>
FunctionReference SafeObjectWrap<T>::DefineClass(
...
template<typename T>
napi_property_descriptor SafeObjectWrap<T>::StaticValue(
...
template<typename T>
napi_property_descriptor SafeObjectWrap<T>::StaticMethod(
...
template<typename T>
napi_property_descriptor SafeObjectWrap<T>::StaticAccessor(
...
template<typename T>
napi_property_descriptor SafeObjectWrap<T>::InstanceValue(
    const PropertyName& id, Napi::Value value,
    napi_property_attributes attributes) noexcept {
  return {
      id.utf8Name,
...
template<typename T>
napi_property_descriptor SafeObjectWrap<T>::InstanceMethod(
    const PropertyName& id,
    ObjectWrapInstanceMethod<T> method,
    napi_property_attributes attributes) noexcept {
  return {
      id.utf8Name,
      id.name,
...
napi_property_descriptor SafeObjectWrap<T>::InstanceMethod(
    const PropertyName& id,
    ObjectWrapInstanceVoidMethod<T> method,
    napi_property_attributes attributes) noexcept {
  return {
      id.utf8Name,
      id.name,
