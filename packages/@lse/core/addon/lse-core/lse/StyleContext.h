...
class StyleContext {
 ...
 private:
    float ComputeBackgroundSize(Style* style, StyleProperty property,
        float dimension, float autoDimension) const noexcept;
    float ComputeObjectFitCoordinate(Style* style, StyleProperty property,
        float dimension, float objectDimension, float defaultPercent) const noexcept;
    float ComputeBorderRadiusProperty(Style* style, StyleProperty property,
